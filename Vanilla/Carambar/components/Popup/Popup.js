...
class Popup extends HTMLElement {
    ...
    display_none_first_version(){        
        let body_v1 = document.getElementById("body-v1");
        let body_v2 = document.getElementById("body-v2");
    ...
    click_to_delete_tab(button, user) {
        button.addEventListener("click", () => {
            ...
            document.getElementById("exampleModalLabel").innerHTML = "Confirmation de rendez-vous avec " + user;
            ...
            let bot_wrapper = document.createElement("div");
    ...
    attributeChangedCallback(attr, oldValue, newValue) {
        if (newValue){            
            let row_download = document.getElementById("row-download");
            if (row_download){
                document.getElementById("body").removeChild(row_download);
                this.display_first_version();
            }
            if (attr === "name") {                   
                document.getElementById("exampleModalLabel").innerHTML = "Carambar " + newValue;
            }
            if (attr === "description") {
            ...
            if (attr === "offers") {
                ...
                document.getElementById("sellers").innerHTML = offers_length.toString() + " vendeurs à proximité";
    ...
    complete_array(offers) {
        let array = document.getElementById("tab");
        array.innerHTML = "";
